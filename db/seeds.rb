...
ActiveRecord::Base.transaction do
  ...
  tokidoki = User.create(first_name: 'Hajime', last_name: 'Taniguchi', email: 'tokidoki777@lucky.com', password: 'tokidoki7', birthdate: 'Jul 7 1985', gender: 'Male', hometown: 'Chiba', school: 'Tokyo University', profile_picture: '', work: 'Professional Gamer', intro_bio: 'Fighting games are something so great', relationship: 'Single');
end